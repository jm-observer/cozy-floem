...
use crate::lines::util::{has_unmatched_pair, matching_char, matching_pair_direction, str_is_pair_left, str_matching_pair};
use crate::lines::{word::{CharClassification, get_char_property} , register::{Clipboard, Register, RegisterData, RegisterKind}};
...
mod test {
    ...
    use crate::lines::edit::{Action, DuplicateDirection};
    use crate::lines::selection::{Selection, SelRegion};
